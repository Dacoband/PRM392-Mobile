...
public class Lab2_3_SignUp extends AppCompatActivity implements View.OnClickListener {
    // Views
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.lab23SignUp), (v, insets) -> {
    ...
    private void signUp() {
        ...
        Intent intent = new Intent(this, Lab2_3_SignIn.class);
