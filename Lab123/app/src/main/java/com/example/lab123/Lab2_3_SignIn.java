...
public class Lab2_3_SignIn extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.lab23SignIn), (v, insets) -> {
    ...
    private void signIn() {
        ...
        // Start MainActivity
        Intent intent = new Intent(this, Lab2_3.class);
        startActivity(intent);
        finish(); // close current activity
    }

    private void signUpForm() {
        Intent intent = new Intent(this, Lab2_3_SignUp.class);
        startActivity(intent);
        finish();
    }
